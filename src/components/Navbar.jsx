...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-8 py-4 flex justify-between items-center bg-dark/80 backdrop-blur-md border-b border-white/5 text-white">
      <Link to="/" className="block transform transition-transform hover:scale-105">
        <img alt="Infrio Solutions Logo" className="h-20 w-auto object-contain" src="/logo.png" />
      </Link>
