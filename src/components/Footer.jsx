  ...
  return (
    <footer className="py-12 border-t border-white/5 bg-dark text-white">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
        <Link to="/" className="block w-28 transition-all cursor-pointer transform hover:scale-105 hover:opacity-100 opacity-80">
          <img alt="Infrio Solutions Small Logo" className="w-full h-auto object-contain" src="/logo.png" />
        </Link>
